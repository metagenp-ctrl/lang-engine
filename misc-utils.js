        ...
        try {
            ...
            if (response.ok) {
                ...
                return {
                    ...
                    shareBonus: status.shareBonus || 0,
                    shareBonusExpiry: status.shareBonusExpiry || '',
                    streakBonus: status.streakBonus || 0,
                    streakBonusExpiry: status.streakBonusExpiry || '',
                    giftBonus: status.giftBonus || 0,
                    giftBonusExpiry: status.giftBonusExpiry || '',
