        ...
        const translations = {
            en: {
                ...
                "knowledge_bl_p": "The stock photography landscape is shifting. AI-generated art and high-volume digital content have increased competition. To stand out, contributors must leverage the same technology to optimize their workflow. MetaGen Pro isn't just a tagger; it's a strategic partner. Our rejection predictor uses historical data to identify potential issues before you even upload.",
                ...
                "knowledge_bl3_p": "Modern stock agency algorithms prioritize \"Relevance\" over simple keyword quantity. This means that having 50 irrelevant keywords is worse than having 20 highly accurate ones. MetaGen Pro’s AI models are trained to prioritize primary subjects and secondary context, ensuring that your images appear in front of the right buyers at the right time.",
                ...
                "expert_tip_sub": "Consistency is key to stock photography success. Aim to upload smaller batches of 20-50 images regularly rather than 500 images once a month. MetaGen Pro's batch tool makes this daily routine quick and painless, ensuring your profile stays fresh and favored by marketplace algorithms.",
                ...
                "hero_showcase_title": "Additional powerful features of Metagen Pro",
                ...
                "hero_showcase_embed_p": "Upload images and CSV file, MetaGen Pro will Embed metadata in the file.",
                "hero_showcase_title_2": "Unlock Powerful Features with Metagen Pro’s Advanced AI",
                ...
                "hero_showcase_eps_p": "Upload EPS file and generate metadata, MetaGen Pro will Embed metadata in the file.",
            ...
            bn: {
                ...
                "knowledge_bl3_p": "আধুনিক স্টক এজেন্সি অ্যালগরিদমগুলো সাধারণ কীওয়ার্ডের পরিমাণের চেয়ে \"প্রাসঙ্গিকতা\" (Relevance)-কে বেশি প্রাধান্য দেয়। এর মানে হলো ৫০টি অপ্রাসঙ্গিক কীওয়ার্ড থাকার চেয়ে ২০টি অত্যন্ত নিখুঁত কীওয়ার্ড থাকা অনেক ভালো। MetaGen Pro-এর AI মডেলগুলো প্রাথমিক বিষয়বস্তু এবং গৌণ প্রেক্ষাপটকে প্রাধান্য দিতে প্রশিক্ষণপ্রাপ্ত, যা নিশ্চিত করে যে আপনার ছবিগুলো সঠিক ক্রেতাদের সামনে সঠিক সময়ে প্রদর্শিত হয়।",
                ...
                "expert_tip_sub": "স্টক ফটোগ্রাফিতে সাফল্যের চাবিকাঠি হলো ধারাবাহিকতা। মাসে একবার ৫০০টি ছবি আপলোড করার চেয়ে নিয়মিত ২০-৫০টি ছবির ছোট ব্যাচ আপলোড করার লক্ষ্য রাখুন। MetaGen Pro-এর ব্যাচ টুল এই দৈনন্দিন রুটিনকে দ্রুত এবং সহজ করে তোলে, যা নিশ্চিত করে যে আপনার প্রোফাইল তাজা থাকে এবং মার্কেটপ্লেসের অ্যালগরিদম দ্বারা পছন্দনীয় হয়।",
            ...
            hi: {
                ...
                "our_mission_h3_sub": "MetaGen Pro द्वारा जनरेट किया गया मेटाडेटा का हर हिस्सा प्रमुख एजेंसी दिशानिर्देशों के अनुपालन को सुनिश्चित करने के लिए वर्तमान बाज़ार रुझानों के साथ क्रॉस-रेफ़रेंस किया जाता है।",
                "knowledge_hub": "MetaGen Pro नॉलेज हब",
                "knowledge_hub_h3": "मेटाडेटा स्टॉक फोटोग्राफी की जीवनरेखा क्यों है",
                "knowledge_hub_p": "डिजिटल युग में, किसी छवि का मूल्य उसकी खोज क्षमता पर निर्भर करता है। हर दिन, Shutterstock और Adobe Stock जैसे प्लेटफॉर्म पर लाखों खोजें की जाती हैं। उच्च गुणवत्ता वाले मेटाडेटा—शीर्षक, विवरण और कीवर्ड—के बिना आपकी शानदार फोटोग्राफी अदृश्य रहती है। MetaGen Pro उन्नत AI का उपयोग करता है ताकि यह सुनिश्चित हो सके कि आपका काम सिर्फ पोर्टफोलियो में न पड़ा रहे, बल्कि वास्तव में उन खरीदारों तक पहुंचे जिन्हें इसकी आवश्यकता है।",
                ...
                "knowledge_bl3_p": "आधुनिक स्टॉक एजेंसी एल्गोरिदम केवल कीवर्ड की मात्रा के बजाय \"प्रासंगिकता\" (Relevance) को प्राथमिकता देते हैं। इसका मतलब है कि 50 अप्रासंगिक कीवर्ड होने से बेहतर 20 अत्यधिक सटीक कीवर्ड होना है। MetaGen Pro के AI मॉडल प्राथमिक विषयों और द्वितीयक संदर्भ को प्राथमिकता देने के लिए प्रशिक्षित हैं, यह सुनिश्चित करते हुए कि आपकी छवियां सही समय पर सही खरीदारों के सामने दिखाई दें।",
                ...
                "hero_showcase_embed_p": "इमेज और CSV फ़ाइल अपलोड करें, MetaGen Pro फ़ाइल में मेटाडेटा एम्बेड कर देगा।",
                "hero_showcase_title_2": "MetaGen Pro के एडवांस AI के साथ शक्तिशाली फीचर्स अनलॉक करें",
                ...
                "hero_showcase_eps_p": "EPS फ़ाइल अपलोड करें और मेटाडेटा जनरेट करें, MetaGen Pro फ़ाइल में मेटाडेटा एम्बेड कर देगा।",
            ...
            es: {
                ...
                "our_mission_h3_sub": "Cada fragmento de metadatos generado por MetaGen Pro se contrasta con las tendencias actuales del mercado para garantizar el cumplimiento de las directrices de las principales agencias.",
                "knowledge_hub": "Centro de Conocimiento de MetaGen Pro",
                "knowledge_hub_h3": "Por qué los Metadatos son el Alma de la Fotografía de Stock",
                "knowledge_hub_p": "En la era digital, una imagen es tan valiosa como su capacidad de ser encontrada. Todos los días se realizan millones de búsquedas en plataformas como Shutterstock y Adobe Stock. Sin metadatos de alta calidad (títulos, descripciones y palabras clave), su impresionante fotografía permanece invisible. MetaGen Pro utiliza IA avanzada para garantizar que su trabajo no se quede estancado en un portafolio, sino que llegue a los compradores que lo necesitan.",
                ...
                "knowledge_bl_p": "El panorama de la fotografía de stock está cambiando. El arte generado por IA y el alto volumen de contenido digital han aumentado la competencia. Para destacar, los colaboradores deben aprovechar la misma tecnología para optimizar su flujo de trabajo. MetaGen Pro no es solo un etiquetador; es un socio estratégico. Nuestro predictor de rechazos utiliza datos históricos para identificar posibles problemas antes de que suba sus imágenes.",
                ...
                "knowledge_bl3_p": "Los algoritmos de las agencias de stock modernas priorizan la \"Relevancia\" sobre la simple cantidad de palabras clave. Esto significa que tener 50 palabras clave irrelevantes es peor que tener 20 altamente precisas. Los modelos de IA de MetaGen Pro están entrenados para priorizar los temas principales y el contexto secundario, asegurando que sus imágenes aparezcan ante los compradores adecuados en el momento adecuado.",
                ...
                "hero_showcase_title": "Funciones potentes adicionales de MetaGen Pro",
                ...
                "hero_showcase_embed_p": "Sube imágenes y un archivo CSV, y MetaGen Pro incrustará los metadatos en el archivo.",
                "hero_showcase_title_2": "Desbloquea funciones potentes con la IA avanzada de MetaGen Pro",
                ...
                "hero_showcase_eps_p": "Sube un archivo EPS y genera metadatos, MetaGen Pro incrustará los metadatos en el archivo.",
            ...
            pt: {
                ...
                "our_mission_h3_sub": "Cada metadado gerado pelo MetaGen Pro é cruzado com as tendências atuais do mercado para garantir a conformidade com as diretrizes das principais agências.",
                "knowledge_hub": "Central de Conhecimento MetaGen Pro",
                "knowledge_hub_h3": "Por que os Metadados são a Essência da Fotografia de Stock",
                "knowledge_hub_p": "Na era digital, uma imagem é tão valiosa quanto sua facilidade de ser encontrada. Todos os dias, milhões de pesquisas são realizadas em plataformas como Shutterstock e Adobe Stock. Sem metadados de alta qualidade—títulos, descrições e palavras-chave—sua incrível fotografia permanece invisível. O MetaGen Pro usa IA avançada para garantir que seu trabalho não fique apenas parado em um portfólio, mas alcance os compradores que precisam dele.",
                ...
                "knowledge_bl_p": "O cenário da fotografia de stock está mudando. A arte gerada por IA e o alto volume de conteúdo digital aumentaram a concorrência. Para se destacar, os colaboradores devem aproveitar a mesma tecnologia para otimizar seu fluxo de trabalho. O MetaGen Pro não é apenas um etiquetador; é um parceiro estratégico. Nosso preditor de rejeições usa dados históricos para identificar possíveis problemas antes mesmo de você fazer o upload.",
                ...
                "expert_tip_sub": "A consistência é a chave para o sucesso na fotografia de stock. Procure enviar lotes menores de 20 a 50 imagens regularmente, em vez de 500 imagens uma vez por mês. A ferramenta em lote do MetaGen Pro torna essa rotina diária rápida e simples, garantindo que seu perfil permaneça atualizado e favorecido pelos algoritmos do mercado.",
                ...
                "hero_showcase_title": "Recursos potentes adicionais do MetaGen Pro",
                ...
                "hero_showcase_embed_p": "Faça upload de imagens e do arquivo CSV, e o MetaGen Pro embutirá os metadados no arquivo.",
                "hero_showcase_title_2": "Desbloqueie recursos potentes com a IA avançada do MetaGen Pro",
                ...
                "hero_showcase_eps_p": "Faça upload de um arquivo EPS e gere metadados, o MetaGen Pro embutirá os metadados no arquivo.",
            ...
            id: {
                ...
                "our_mission_h3_sub": "Setiap metadata yang dihasilkan oleh MetaGen Pro disilangkan dengan tren pasar saat ini untuk memastikan kepatuhan terhadap pedoman agensi utama.",
                "knowledge_hub": "Pusat Pengetahuan MetaGen Pro",
                "knowledge_hub_h3": "Mengapa Metadata adalah Nadi Fotografi Stock",
                "knowledge_hub_p": "Di era digital, nilai sebuah gambar bergantung pada kemudahannya untuk ditemukan. Setiap hari, jutaan pencarian dilakukan di platform seperti Shutterstock dan Adobe Stock. Tanpa metadata berkualitas tinggi—judul, deskripsi, dan kata kunci—fotografi Anda yang memukau tetap tidak akan terlihat. MetaGen Pro menggunakan AI canggih untuk memastikan karya Anda tidak hanya mengendap di portofolio, tetapi benar-benar menjangkau pembeli yang membutuhkannya.",
                ...
                "knowledge_bl_p": "Lansekap fotografi stock sedang bergeser. Seni yang dihasilkan AI dan konten digital dalam jumlah besar telah meningkatkan persaingan. Untuk tampil menonjol, kontributor harus memanfaatkan teknologi yang sama untuk mengoptimalkan alur kerja mereka. MetaGen Pro bukan sekadar penanda (tagger); ini adalah mitra strategis. Prediktor penolakan kami menggunakan data historis untuk mengidentifikasi potensi masalah sebelum Anda mengunggahnya.",
                ...
                "knowledge_bl3_p": "Algoritma agensi stock modern memprioritaskan \"Relevansi\" daripada sekadar kuantitas kata kunci. Ini berarti memiliki 50 kata kunci yang tidak relevan lebih buruk daripada memiliki 20 kata kunci yang sangat akurat. Model AI MetaGen Pro dilatih untuk memprioritaskan subjek utama dan konteks sekunder, memastikan gambar Anda muncul di hadapan pembeli yang tepat pada waktu yang tepat.",
                ...
                "expert_tip_sub": "Konsistensi adalah kunci kesuksesan fotografi stock. Usahakan untuk mengunggah batch yang lebih kecil berisi 20-50 gambar secara teratur daripada 500 gambar sebulan sekali. Alat pemrosesan batch MetaGen Pro membuat rutinitas harian ini cepat dan mudah, memastikan profil Anda tetap segar dan disukai oleh algoritma pasar.",
                ...
                "hero_showcase_title": "Fitur canggih tambahan dari MetaGen Pro",
                ...
                "hero_showcase_embed_p": "Unggah gambar dan file CSV, MetaGen Pro akan menyematkan metadata dalam file.",
                "hero_showcase_title_2": "Buka Fitur Canggih dengan AI Tingkat Lanjut MetaGen Pro",
                ...
                "hero_showcase_eps_p": "Unggah file EPS dan hasilkan metadata, MetaGen Pro akan menyematkan metadata dalam file.",
            ...
            de: {
                ...
                "knowledge_bl3_p": "Moderne Algorithmen von Stock-Agenturen priorisieren „Relevanz“ gegenüber der reinen Keyword-Menge. Das bedeutet, dass 50 irrelevante Keywords schlechter sind als 20 hochpräzise. Die KI-Modelle von MetaGen Pro sind darauf geschult, primäre Motive und sekundäre Kontexte zu priorisieren, um sicherzustellen, dass Ihre Bilder zum richtigen Zeitpunkt den richtigen Käufern angezeigt werden.",
                ...
                "expert_tip_sub": "Kontinuität ist der Schlüssel zum Erfolg in der Stock-Fotografie. Versuchen Sie, regelmäßig kleinere Stapel von 20–50 Bildern hochzuladen, anstatt einmal im Monat 500 Bilder. Das Batch-Tool von MetaGen Pro macht diese tägliche Routine schnell und schmerzlos und sorgt dafür, dass Ihr Profil frisch bleibt und von Marktplatz-Algorithmen bevorzugt wird.",
                ...
                "hero_showcase_title": "Zusätzliche leistungsstarke Funktionen von MetaGen Pro",
                ...
                "hero_showcase_embed_p": "Laden Sie Bilder und eine CSV-Datei hoch; MetaGen Pro bettet die Metadaten in die Datei ein.",
                "hero_showcase_title_2": "Schalten Sie leistungsstarke Funktionen mit der fortgeschrittenen KI von MetaGen Pro frei",
                ...
                "hero_showcase_eps_p": "Laden Sie eine EPS-Datei hoch und generieren Sie Metadaten; MetaGen Pro bettet die Metadaten in die Datei ein.",
            ...
            ru: {
                ...
                "knowledge_bl_p": "Ландшафт стоковой фотографии меняется. Искусство, созданное ИИ, и большие объемы цифрового контента усилили конкуренцию. Чтобы выделяться, авторы должны использовать те же технологии для оптимизации своего рабочего процесса. MetaGen Pro — это не просто теггер, это ваш стратегический партнер. Наш предиктор отклонений использует исторические данные для выявления потенциальных проблем еще до загрузки.",
                ...
                "knowledge_bl3_p": "Алгоритмы современных стоковых агентств отдают приоритет «Релевантности», а не просто количеству ключевых слов. Это означает, что 50 нерелевантных ключевых слов хуже, чем 20 точных. Модели ИИ MetaGen Pro обучены отдавать приоритет основным объектам и вторичному контексту, гарантируя, что ваши изображения увидят нужные покупатели в нужное время.",
                ...
                "hero_showcase_title": "Дополнительные мощные функции MetaGen Pro",
                ...
                "hero_showcase_embed_p": "Загрузите изображения и CSV-файл, и MetaGen Pro внедрит метаданные в файл.",
                "hero_showcase_title_2": "Разблокируйте мощные функции с помощью продвинутого ИИ MetaGen Pro",
                ...
                "hero_showcase_eps_p": "Загрузите файл EPS и сгенерируйте метаданные, MetaGen Pro внедрит метаданные в файл.",
            ...
            fr: {
                ...
                "expert_tip_sub": "La régularité est la clé du succès en photographie de stock. Visez à téléverser régulièrement de petits lots de 20 à 50 images plutôt que 500 images une fois par mois. L'outil de traitement par lots de MetaGen Pro rend cette routine quotidienne rapide et sans effort, garantissant que votre profil reste actif et favorisé par les algorithmes des plateformes.",
                ...
                "hero_showcase_title": "Fonctionnalités puissantes supplémentaires de MetaGen Pro",
                ...
                "hero_showcase_embed_p": "Téléversez des images et un fichier CSV, MetaGen Pro incorporera les métadonnées dans le fichier.",
                "hero_showcase_title_2": "Débloquez des fonctionnalités puissantes grâce à l'IA avancée de MetaGen Pro",
                ...
                "hero_showcase_eps_p": "Téléversez un fichier EPS et générez des métadonnées, MetaGen Pro incorporera les métadonnées dans le fichier.",
            ...
            ja: {
                ...
                "our_mission_h3_sub": "MetaGen Proによって生成されるすべてのメタデータは、主要エージェンシーのガイドラインに準拠していることを確認するために、現在のマーケットプレイスのトレンドと相互参照されます。",
                "knowledge_hub": "MetaGen Pro ナレッジハブ",
                "knowledge_hub_h3": "なぜメタデータがストックフォトの生命線なのか",
                "knowledge_hub_p": "デジタル時代において、画像の価値は見つけやすさで決まります。毎日、ShutterstockやAdobe Stockなどのプラットフォームで何百万もの検索が行われています。タイトル、説明文、キーワードなどの高品質なメタデータがなければ、あなたの素晴らしい写真は見えないままになってしまいます。MetaGen Proは高度なAIを活用し、あなたの作品がポートフォリオに眠るだけでなく、それを必要とする購入者に確実に届くようにします。",
                ...
                "knowledge_bl_p": "ストックフォトの状況は変化しています。AI生成アートや大量のデジタルコンテンツにより、競争が激化しています。他と差をつけるために、コントリビューターは同じテクノロジーを活用してワークフローを最適化する必要があります。MetaGen Proは単なるタグ付けツールではなく、戦略的パートナーです。当社の審査リジェクト予測機能は、過去のデータを使用してアップロード前に潜在的な問題を特定します。",
                ...
                "knowledge_bl3_p": "現代のストックエージェンシーのアルゴリズムは、単なるキーワードの量よりも「関連性（Relevance）」を優先します。つまり、無関係なキーワードが50個あるよりも、非常に正確なキーワードが20個ある方が良いのです。MetaGen ProのAIモデルは、主要な被写体と二次的な文脈を優先するようにトレーニングされており、適切なタイミングで適切な購入者に写真が表示されるようにします。",
                ...
                "expert_tip_sub": "ストックフォトで成功するための鍵は「一貫性」です。月に1回500枚の画像をアップロードするのではなく、20〜50枚の小さなバッチを定期的にアップロードすることを目指しましょう。MetaGen Proのバッチツールを使用すると、この毎日のルーティンが迅速かつ簡単になり、プロフィールが常に新鮮に保たれ、マーケットプレイスのアルゴリズムに好まれるようになります。",
                ...
                "hero_showcase_title": "MetaGen Proの追加の強力な機能",
                ...
                "hero_showcase_embed_p": "画像とCSVファイルをアップロードすると、MetaGen Proがファイルにメタデータを埋め込みます。",
                "hero_showcase_title_2": "MetaGen Proの高度なAIで強力な機能を解放",
                ...
                "hero_showcase_eps_p": "EPSファイルをアップロードしてメタデータを生成すると、MetaGen Proがファイルにメタデータを埋め込みます。",
