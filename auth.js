...
async function showMainApp(email, displayName, avatarUrl) {
    ...
    if (email) {
        ...
        const userProfileElOut = document.getElementById('userProfile');
        if (userProfileElOut) userProfileElOut.classList.remove('visible');
        const userEmailElOut = document.getElementById('userEmail');
        if (userEmailElOut) userEmailElOut.textContent = '';
